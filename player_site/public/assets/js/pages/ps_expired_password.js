 ...
 * @author PS Team
 */
define('ps_expired_password', ['ps_view', 'ps_model','ps_validator', 'ps_store'], function() {
    ...
    var globals   = { is_page_renderend:false, form_id:0, store: new ps_store('ps_expired_password') };
    var callables = {
        /**
        ...
        form_submit: function(form) {
            ...
            if (!info_store.loading) {
                ...
                ps_model.expired_password(ps_helper.json_serialize(form), {
    ...
    return {
        ...
        activate: function(hash, hash_info) {
            ...
            if (!globals.is_page_rendered) {
                ...
                ps_view.render($('.ps_js-page_'+hash_info.page), 'expired_password', {
                    replace: false, 
                    data   : { 
                                hash_info: hash_info, 
                                page_info:page_info, 
                    ...
                    mounted: function() {
                                ...
                                callables.view_data(function(response) {
                                    ...
                                    vm.$nextTick(function() {
                                        var form = $(vm.$el).find('.ps_js-expired_password_form');
                                        ...
                                        // buttons
                                        form.find('.ps_js-expired_password_reset').on('click', function() {
